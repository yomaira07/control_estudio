...
class Unidad_creditos_model extends CI_Model {

	public function getUnidadCreditos(){
		$this->db->order_by('id', 'ASC');
		$resultados = $this->db->get("unidad_creditos");
		return $resultados->result();
	}


	public function save($data){
		return $this->db->insert("unidad_creditos",$data);


	}

	public function getUltimoUnidadCreditos(){
...
public function getUltimoUnidadCreditos_maestria(){
