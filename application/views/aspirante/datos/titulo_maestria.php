     ...
     location.href="<?php echo base_url()?>dashboard08/requisitos";
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <h3 class="card-title"><strong>Adjuntar Título de Magíster  </strong></h3>
                    </div>
<div class="frame3" >
  ...
  <p align="center">
    ...
    //$rutaarchivo = 'recursos/fotos/' . LocalUser::getCurrentUser()->getIdPersona() . '_foto.jpg';
      $rutaarchivo = base_url().'assets/magister/' . $this->session->userdata('id') . '_magister.jpg';
    //echo $rutaarchivo ;
 ...
 <h5 style="color: #FF0000;"align="center"><b>IMPORTANTE:</b> Requisito Obligatorio.</h5> 
  ...
  <form id="formulario" method="post" enctype="multipart/form-data" action="cargarmagister">
