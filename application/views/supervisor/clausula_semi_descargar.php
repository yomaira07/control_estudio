       ...
       <table width="100%" align="center"   border="0"  cellPadding="2" cellSpacing="1" style=" font-size:8pt; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif" >  
          ...
          <td  colspan="8" height="40">
               ...
               <?php foreach($clausula  as $clausula): 
                ...
                <div class="row" align="justify" style=" font-size:12pt; font-family:'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif">
                    <div class="col-md-12">
                ...
                <div class="col">
                    ...
                    style="width: 15mm; height: 15mm; margin: 0;" title="MODALIDAD SEMIPRESENCIAL"/>
                               ...
                               y la Escuela Nacional de Fiscales del Ministerio Público, donde se establece que:
                                ...
                                <p align="center" >Aceptó los términos y condiciones <b>MODALIDAD SEMIPRESENCIAL</b> la fecha y hora <?php echo $acepto;?></p>
