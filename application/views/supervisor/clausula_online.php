       ...
       <div class="card">
            ...
            <p aling="justify">   <img src="<?php echo base_url(); ?>assets/img/presencial.jpeg" title="MODALIDAD PRESENCIAL"
                    style="width: 15mm; height: 15mm; margin: 0;"/> y la Escuela Nacional de Fiscales del Ministerio Público, donde se establece que:</p>
                        ...
                        <p align="center" > 
                                  <a href="<?php  echo base_url()?>dashboard05/clausula_pre_descargar/<?php echo $datos_alumnos->id_usuario;?>"" target="_blank"><img src="<?php echo base_url(); ?>assets/img/pdf.jpeg"  alt="PDF" style="width: 10mm; height: 10mm; margin: 0;" />Imprimir</a>
               </p>
                                </div>                    
                                </div>  
                        </div>                
                    ...
                    style="width: 15mm; height: 15mm; margin: 0;"/>
                        ...
                        <div class="col-12" >
                                ...
                                <p align="center" ><h5>"Aceptó los términos y condiciones <b>MODALIDAD A DISTANCIA</b> <?php echo $acepto;?></h5>
                                  ...
                                  <p align="center" > 
                                  <a href="<?php  echo base_url()?>dashboard05/clausula_dis_descargar/<?php echo $datos_alumnos->id_usuario;?>"" target="_blank"><img src="<?php echo base_url(); ?>assets/img/pdf.jpeg"  alt="PDF" style="width: 10mm; height: 10mm; margin: 0;" />Imprimir</a>
               </p> 
                                </div>                    
                        </div>                   
                        </div>
                ...
                <div class="col">
                    ...
                    style="width: 15mm; height: 15mm; margin: 0;" title="MODALIDAD SEMIPRESENCIAL"/>
                                ...
                                <p align="center" ><h5>"Aceptó los términos y condiciones <b>MODALIDAD SEMIPRESENCIAL</b> <?php echo $acepto;?></h5>
                                  ...
                                  <p align="center" > 
                                  <a href="<?php  echo base_url()?>dashboard05/clausula_sp_descargar/<?php echo $datos_alumnos->id_usuario;?>"" target="_blank"><img src="<?php echo base_url(); ?>assets/img/pdf.jpeg"  alt="PDF" style="width: 10mm; height: 10mm; margin: 0;" />Imprimir</a>
               </p>
                                </div>                    
                        </div>                   
                        </div>
                ...
                <div class="col">
                    ...
                    style="width: 15mm; height: 15mm; margin: 0;" title="CLAÚSULA TEG O TG"/>
                                ...
                                <div align="center" >
                                  ...
                                  <p align="center" > 
                                  <a href="<?php  echo base_url()?>dashboard05/clausula_teg_descargar/<?php echo $datos_alumnos->id_usuario;?>"" target="_blank"><img src="<?php echo base_url(); ?>assets/img/pdf.jpeg"  alt="PDF" style="width: 10mm; height: 10mm; margin: 0;" />Imprimir</a>
               </p> 
