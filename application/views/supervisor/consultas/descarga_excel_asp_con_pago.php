<?php
$nombre_archivo='aspirantes__con_pago_sinrequisitos'.date("dmyhis");
    ...
    ?>
        ...
        <tr align="center" style="background: grey;">
           <td> <b>Usuario Registrado</b></td>
            ...
            <td><b>Referencia Bancaria</b></td>    
            <td><b>Fecha Transferencia</b></td>     
            <td><b>Banco</b></td>  
            <td><b>Monto a Pagar</b></td>
            <td><b>MOnto depositado</b></td>           
      ...
      // var_dump( $registro_listado);
         foreach($registros as $registros ){
           ...
           <tr>
              ...
              <td ><?php echo $registros['nro_referencia'];?></td>    
              <td ><?php echo $registros['fecha_transferencia'];?></td>              
              <td ><?php if($registros['banco']==1) echo "Venezuela";if($registros['banco']==2) echo "Banesco";?></td>                
              <td ><?php echo $registros['monto_apagar'];?></td>   
              <td ><?php echo $registros['monto_depositado'];?></td>     
           </tr>
       <?php  }?>
