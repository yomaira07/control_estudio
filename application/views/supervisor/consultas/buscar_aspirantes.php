    ...
    <section class="content">
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <div class="alert alert-info" role="alert">Buscar Período de Pre - Inscripción</div>
                    </div>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- Comienzo formulario -->
           <div class="col-md-3">
            <form action="<?php echo base_url()?>consultas/listado_general_aspirantes/" method="POST" name=carga >
