                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-5">
                        <input type="text" class="form-control" id="telefono_hab" placeholder="" name="telefono_hab" value="<?php if ($datos_alumnos==false){echo "";}else{ echo $tel_habitacion = $datos_alumnos->tel_habitacion;  } 
                        ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-5">
                        <input type="text" class="form-control" id="telefono_celwhat" placeholder="" name="telefono_celwhat" value="<?php if ($datos_alumnos==false){echo "";}else{ echo $tel_habitacion = $datos_alumnos->telefono_whatsapp;  } 
                        ?>">
                      </div>
                    </div>
                  </div>
              ...
              <!-- /.col -->
                <div class="col-md-6">  
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="correo" placeholder="ejemplo@gmail.com" name="correo" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php if ($datos_alumnos==false){echo "";}else{ echo $datos_alumnos->correo;  } 
                        ?>" required>
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="row">
                      ...
                      <div class="col-5" >
                        <input type="text" class="form-control" id="telefono_cel" placeholder="" name="telefono_cel" value="<?php if ($datos_alumnos==false){echo "";}else{ echo $tel_habitacion = $datos_alumnos->tel_celular;  } 
                        ?>">
                      </div>
                    </div>
                  </div> 
