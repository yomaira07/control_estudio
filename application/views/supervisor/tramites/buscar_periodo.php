    ...
    <section class="content">
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <div class="alert alert-success" role="alert">Buscar Período de Registro del Trámite</div>
                    </div>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- Comienzo formulario -->
           <div class="col-md-3">
            <form action="<?php echo base_url()?>dashboard09/consultas/" method="POST" name=carga >
