    ...
    <section class="content">
       ...
       <div class="card">
                    ...
                    <div class="info-box">
                      ...
                      <div class="alert alert-success" role="alert">Buscar Trámites y/o Solicitudes  del Estudiante </div>
                    </div>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- Comienzo formulario -->
           <div class="col-md-3">
            <form action="<?php echo base_url()?>dashboard09/mostrar_tramtes_cedula/" method="POST" name=carga >
