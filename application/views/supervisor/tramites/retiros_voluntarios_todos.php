                  ...
                  <div class="card-body">
                      <div class="card">
                          ...
                          <div class="card-header">
                            <h3 class="card-title"> <b>RETIROS VOLUNTARIOS</b> REVISADOS - Período Académico: <b><?php echo $periodo->nombre;?></b></h3>
<div align="right" ><a title="Descargar a Excel" href="<?php  echo base_url()?>dashboard09/excel_retiros" target="_blank"><img src="<?php echo base_url(); ?>assets/img/excel.jpg"  alt="Excel" style="width: 10mm; height: 10mm; margin: 0;" /></a></div> 
                          </div>
...
<td> <?php if( $listado->rev_academica==1 and  $listado->retiro==0 and $listado->revision_solicitud==1) echo "Trámite Revisado sin Aprobación";elseif( $listado->rev_academica==1 and  $listado->retiro==1 and $listado->revision_solicitud==1) echo "Trámite Revisado y Aprobado" ;elseif($listado->revision_solicitud==2 ) echo "Trámite Revisado y Rechazado" ;?></td> 
                  <td>  <div>   <b>REQUISITOS</b> <img higth="25px"width="25px" src="<?php echo base_url()?>/assets/img/blanco.png"  ><a href="<?php echo base_url()?>assets/tramites/retiro_voluntario/<?php echo $listado->id_usuario.'_retiro_voluntario.pdf'; ?>"  title ="Ver Requisito" target="_new">  Ver</a></div></td>
                  </tr>
