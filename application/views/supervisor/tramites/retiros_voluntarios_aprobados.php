      ...
      <!-- /.card -->
              <div class="card card-primary card-outline">
                  ...
                  <th>Cédula</th>
                    ...
                    <th>Unidad Curricular Tramitada</th>  
                  ...
                  <tr>
                    ...
                    <td><?php  if($listado->rol_id==5)echo 'REGULAR';  else if($listado->rol_id=='8')echo 'NUEVO INGRESO'; ?></td>                  
                     ...
                     <td><?php echo $listado->pensum;?></td>
                     <td> <?php echo $listado->tramite; ?></td> 
                     <td> <?php if( $listado->rev_academica==1 and  $listado->retiro==0) echo "Trámite Revisado sin Aprobación";elseif( $listado->rev_academica==1 and  $listado->retiro==1) echo "Trámite Revisado y Aprobado" ;?></td> 
                  <td>  <a href="<?php echo base_url()?>assets/tramites/retiro_voluntario/<?php echo $listado->id_usuario.'_retiro_voluntario.pdf'?>" class="btn btn-warning" >Ver Documento</a> </td>
                  </tr>
