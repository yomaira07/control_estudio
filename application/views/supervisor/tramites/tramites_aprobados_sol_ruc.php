              ...
              <div class="card card-primary card-outline">
                  <div class="card-body">
                      <div class="card">
                          ...
                          <div class="card-header">
                            <h3 class="card-title">TRÁMITES Y SOLICITUDES APROBADOS POR SOLICITUD DE RUC- Período Académico: <b><?php echo $periodo->nombre; ?></b></h3>
                            <div align="right" ><a title="Descargar a Excel" href="<?php  echo base_url()?>dashboard09/excel_sol_ruc/<?php echo $periodo->id;?>" target="_blank"><img src="<?php echo base_url(); ?>assets/img/excel.jpg"  alt="Excel" style="width: 10mm; height: 10mm; margin: 0;" /></a></div>                           
                          </div>
                  ...
                  <tr>
                    ...
                    <td><?php  if($listado->rol_id==5)echo 'REGULAR';  else if($listado->rol_id=='8')echo 'NUEVO INGRESO'; ?></td>                  
                     ...
                     <td> <div>
                            <a href="<?php  echo base_url()?>dashboard09/revisar_documento_ruc/<?php  echo $listado->id_solicitud;?>/<?php  echo $listado->id_usuario;?>/<?php echo $listado->id_programa;?>"><img src="<?php echo base_url()?>/assets/img/icons8-Show Property.png"   title ="Ver Documentos Cargados "> Ver</a>
                         </div>
