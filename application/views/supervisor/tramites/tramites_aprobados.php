              ...
              <div class="card card-primary card-outline">
                  <div class="card-body">
                      <div class="card">
                           ...
                           <div class="card-header">
                            <h3 class="card-title">TRÁMITES Y SOLICITUDES APROBADOS - Período Académico: <b><?php echo $periodo->nombre;$periodoid=$periodo->id;foreach($periodo as $periodo): echo $periodo->nombre;endforeach?></b></h3>
                            <div align="right" ><a title="Descargar a Excel" href="<?php  echo base_url()?>dashboard09/excel_aprobados/<?php echo $periodoid; echo $periodo->id;?>" target="_blank"><img src="<?php echo base_url(); ?>assets/img/excel.jpg"  alt="Excel" style="width: 10mm; height: 10mm; margin: 0;" /></a></div>                           
                          </div>
                  ...
                  <tr>
                    ...
                    <td><?php  if($listado->rol_id==5)echo 'REGULAR';  else if($listado->rol_id=='8')echo 'NUEVO INGRESO'; ?></td>                  
                     ...
                     <td> <?php  if($listado->id_tramite=="16" and $listado->rev_academica==1)echo "Trámite en Proceso de Revisión";else if($listado->id_tramite<>"16" and $listado->rev_academica==1) echo "Trámite Aprobado";else echo "Trámite Pendiente por Aprobar" ;?></td> 
