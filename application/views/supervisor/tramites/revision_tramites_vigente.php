...
<div class="content-wrapper">
    ...
    <section class="content">
        <script language="javascript">
            function anterior() { 
                location.href = "/control_estudio/dashboard09/tramites_por_validar";
            }
        </script>
        ...
        <div class="card card-primary card-outline">
            <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <?php if(!empty($datos_alumno)): ?>
                                    ...
                                    <table class="table table-sm table-borderless">
                                        ...
                                        <?php if($listado->id_tramite==18): ?>
                                        <tr>
                                            <th>Modalidad de Egreso:</th>
                                            <td>
                                                <?php 
                                                    if($listado->id_tipo_reconocimiento==5){ echo "ASISTENCIA AL ACTO SOLEMNE DE GRADO";}
                                                    if($listado->id_tipo_reconocimiento==6){ echo "POR SECRETARIA"; } 
                                                ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    $rutaarchivo_solicitud = base_url().'assets/tramites/egresos/' . $listado->id_usuario.'_solicitud_egreso.pdf';
                                                    echo("<a href='".$rutaarchivo_solicitud."' target='_new' class='btn btn-sm btn-warning'>Ver Documento</a>");
                                                ?>
                                            </td>
                                        </tr>
                                        <?php endif; ?>
                ...
                <form action="<?php echo base_url()?>dashboard09/registro_validacion_tramite_store/<?php echo $listado->id_solicitud.'/'.$listado->id_usuario.'/'.$listado->id_programa; ?>" method="POST">
                    ...
                    <!-- DOCUMENTOS PARA TRÁMITE ID=16 -->
                    <?php if($listado->id_tramite=="16"): ?>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 text-center">
                                    ...
                                    <?php 
                                        $rutaarchivo_cedula = base_url().'assets/cedulas/' . $listado->id_usuario. '_cedula.jpg';
                                        echo("<a href='".$rutaarchivo_cedula."' target='_new' class='btn btn-sm btn-primary mt-2'>Ver Documento</a>");
                                    ?>
                                </div>
                                <div class="col-md-3 text-center">
                                    <strong>Carnet o Carta de Trabajo</strong><br>
                                    <?php 
                                        $rutaarchivo_carnet = base_url().'assets/carnet/' . $listado->id_usuario. '_carnet.jpg';
                                        echo("<a href='".$rutaarchivo_carnet."' target='_new' class='btn btn-sm btn-primary mt-2'>Ver Documento</a>");
                                    ?>
                                </div>
                                <div class="col-md-3 text-center">
                                    <strong>Carta de Solicitud</strong><br>
                                    <?php 
                                        $rutaarchivo_solicitud = base_url().'assets/tramites/reincorporaciones/solicitud/' . $listado->id_usuario.'_'.$listado->id_programa.'_solicitud.pdf';
                                        echo("<a href='".$rutaarchivo_solicitud."' target='_new' class='btn btn-sm btn-primary mt-2'>Ver Documento</a>");
                                    ?>
                                </div>
                                <div class="col-md-3 text-center">
                                    <strong>Record Académico</strong><br>
                                    <?php 
                                        $rutaarchivo_record = base_url().'assets/tramites/reincorporaciones/record/' . $listado->id_usuario. '_record.pdf';
                                        echo("<a href='".$rutaarchivo_record."' target='_new' class='btn btn-sm btn-primary mt-2'>Ver Documento</a>");
                                    ?>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                                        ...
                                                        foreach ($archivos as $archivo) {
                                                            if ($archivo != "." && $archivo != "..") {
                                                              ...
                                                              $icono = (pathinfo($archivo, PATHINFO_EXTENSION) == 'pdf') ? 'fa-file-pdf text-danger' : 'fa-file-image text-primary';
                                                                echo "<a href='".base_url().'assets/tramites/ruc_tit_'.$listado->id_programa.'_'.$datos_alumno->cedula.'/'.$archivo."' target='_blank' class='d-block mb-2'> 
                                                                <i class='fas $icono fa-lg mr-2'></i>
                                                                (Size:$tamaño_kb KB) ".$archivo."</a>";
                                                                $i++;
                                                            }
                                                            ?>
                                            ...
                                            <div class="card-footer bg-light text-white">
                                                         <strong>Total de archivos cargados ( <?php echo $i;?> )</strong>
                                                        </div>
                                        </div>
                                    </div>
                                </div>                              
                            ...
                            <?php elseif($listado->id_tipo_reconocimiento==2): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header bg-light text-white">
                                                <strong>Programas de estudios o contenidos programáticos,etc.</strong>
                                            </div>
                                            <div class="card-body">
                                                <?php  
                                                    ...
                                                    if (is_dir($dir)) {
                                                        ...
                                                        foreach ($archivos as $archivo) {
                                                          ...
                                                          $icono = (pathinfo($archivo, PATHINFO_EXTENSION) == 'pdf') ? 'fa-file-pdf text-danger' : 'fa-file-image text-primary';
                                                            if ($archivo != "." && $archivo != "..") {
                                                                echo "<a href='".base_url().'assets/tramites/ruc_pro_'.$listado->id_programa.'_'.$datos_alumno->cedula.'/'.$archivo."' target='_blank' class='d-block mb-2'>
                                                                <i class='fas $icono fa-lg mr-2'></i>
                                                                (Size:$tamaño_kb KB) ".$archivo."</a>";
                                                                $i++;
                                                            }
                            ...
                            <?php elseif($listado->id_tipo_reconocimiento==3 or $listado->id_tipo_reconocimiento==4): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header bg-light text-white">
                                                <strong>Constancias de experiencia laboral y/o docente</strong>
                                            </div>
                                            <div class="card-body">
                                                <?php  
                                                    ...
                                                    if (is_dir($dir)) {
                                                        ...
                                                        foreach ($archivos as $archivo) {
                                                            if ($archivo != "." && $archivo != "..") {
                                                                echo "<a href='".base_url().'assets/tramites/ruc_lab_'.$listado->id_programa.'_'.$datos_alumno->cedula.'/'.$archivo."' target='_blank' class='d-block mb-2'>
                                                                <i class='fas $icono fa-lg mr-2'></i>
                                                                (Size:$tamaño_kb KB) ".$archivo."</a>";
                                                                $i++;
                                                            }
                    ...
                    <div class="row mt-4">
                        <div class="col-12 text-center">
                            ...
                            <?php if($listado->id_tramite=="18"): ?>
                                <a href="<?php echo base_url()?>assets/tramites/egresos/<?php echo $listado->id_usuario.'_solicitud_egreso.pdf'?>" target="_new" class="btn btn-warning">Ver Documento</a>
                            <?php endif; ?>
                        </div>
                        <div class="col-12 text-center mt-3">
                            <input type="submit" name="btnguardar" id="btnguardar" class="btn btn-success btn-lg" value="APROBADO" /> 
                            <a href="<?php echo base_url()?>dashboard09/registro_validacion_tramite_store2/<?php echo $listado->id_solicitud.'/'.$listado->id_usuario.'/'.$listado->id_programa; ?>" class="btn btn-danger btn-lg">RECHAZADO</a>
                        </div>
                    </div>
                </form>
                <?php endif; ?>
