        ...
        table{border-collapse: collapse;  font-style: normal; font-weight: normal;  font-size: 11px;break-after:page;}
         ...
         <tr bgcolor="#D0E0F4" color="#1060C8" >
            ...
            <th colspan="8" >
              ...
              ?>
                <div align="center"><b>REGISTRO DE ASPIRANTES A CURSAR PROGRAMAS DE POSTGRADO <br>  <?php echo $especializacion->nombre; ?>  <br>SEDE: DISTRITO CAPITAL <br> AÑO <?php $periodo=date("Y"); echo date("Y"); echo "-"; echo date("Y")+1; ?> </b>   </div>
            </th>              
              ...
              <?php $suma_pago=$registro_pago->monto_depositado+$suma_pago;
               ...
               <tr  bgcolor="#999999" color="#FFFFFF" >
                ...
                <tr>
                 ...
                 <tr  bgcolor="#D0E0F4" color="#1060C8" >
                  <th colspan="8"><div align="center" >PARA SER LENADO POR EQUIPO DE ENTREVISTA</div></th>
                </tr>
                
                
                <tr>  
                       <td height="139" colspan="4" >OBSERVACIONES </td> 
                      
                       <td height="139" colspan="4" > <div align="center" >Fecha:___/___/_____ <br><br>Nombre(s) y Apellido(s) del Entrevistador(a):<br>____________________________________<br>
                       <br>Nombre(s) y Apellido(s) del Entrevistador(a):<br>____________________________________<br>
                       <br>Nombre(s) y Apellido(s) del Entrevistador(a):<br>____________________________________<br></div></td> 
                    </tr>
             </table>
      <!-- DATOS ESTUDIANTE -->
        <table width="100%" align="center"  border="1"  cellPadding="2" cellSpacing="1" >   
