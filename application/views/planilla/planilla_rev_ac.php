    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <form action="<?php echo base_url();?>dashboard05/descargar/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4);?>" method="POST" target="_blank">
                    ...
                    <table class="table-bordered" cellPadding="3" style="margin-top: 2px;">
                        ...
                        <tr>
                            ...
                            <td class="data-cell text-center <?php 
                                if($registro_pago->convenio_pago == 1) {
                                    echo 'badge-info';
                                } elseif($registro_pago->conciliado == 1) {
                                    echo 'badge-success';
                                } else {
                                    echo 'badge-warning';
                                }
                    ...
                    <div style="text-align: center; margin-top: 15px;" class="no-print">
                        <button type="submit" name="btnDownload" class="btn-download">
