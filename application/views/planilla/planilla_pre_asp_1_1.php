  ...
  <div class="content-wrapper">
   ...
   <form  action="<?php echo base_url();?>dashboard05/descargar_pla_pre_asp/<?php echo $this->uri->segment(3).'/'.$this->uri->segment(4).'/'.$this->uri->segment(5);?> " method="POST">
         ...
         <tr bgcolor="#D0E0F4" color="#1060C8" >
            ...
            <th colspan="8" >
              ...
              ?>
                <div align="center"><b>REGISTRO DE ASPIRANTES A CURSAR PROGRAMAS DE POSTGRADO <br>  <?php echo $especializacion->nombre; ?>  <br>SEDE: DISTRITO CAPITAL <br> AÑO 2024-2025<?php //$periodo=date("Y"); echo date("Y"); echo "-"; echo date("Y")+1; ?> </b>   </div>
            </th>              
          ...
          <tr bgcolor="#999999" color="#FFFFFF">
                ...
                <tr>
                    ...
                    <th colspan="4"><div align="center">CORREO ELECTRÓNICO</div></th>  
                ...
                <tr>
                   <th> SEXO</th>
                    ...
                    <td ><?php echo date('d-m-Y',strtotime($datos_alumnos->fecha_nac)).' / '.$edad.' años';?></td>
      ...
      <!-- DATOS ESTUDIANTE -->
        <table width="100%" align="center"  border="1"  cellPadding="2" cellSpacing="1" >   
              ...
              <p align="center"  style="font-style: normal; font-weight: normal;  font-size: 8px;"><b>NOTA: EN CASO DE  QUEDAR SELECCIONADA/O EN LA FASE DE ENTREVISTA, DEBERÁ IMPRIMIR, FIRMAR Y PRESENTAR ESTA PLANILLA JUNTO A LA FOTOCOPIA DE LA CÉDULA DE IDENTIDAD EL DÍA QUE LE CORRESPONDA.</b>
  <p>
