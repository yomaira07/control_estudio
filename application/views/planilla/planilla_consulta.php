    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <form action="<?php echo base_url();?>consultas/descargar/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>" method="POST" target="_blank">
                    ...
                    <table class="table-bordered" cellPadding="3" style="margin-top: 2px;">
                        ...
                        <tr>
                            ...
                            <td class="data-cell" colspan="7"><?php echo $circunscripcion->estado; ?></td>
                        </tr>
                    </table>
                    ...
                    <div style="text-align: center; margin-top: 15px;" class="no-print">
                        <a href="<?php echo base_url();?>consultas/descargar/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4);?>/<?php echo $this->uri->segment(5);?>" 
                           target="_blank" 
                           class="btn-download">
