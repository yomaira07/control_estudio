    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-body">
                ...
                <form action="<?php echo base_url();?>planilla/descargar/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4);?>" method="POST" target="_blank">
                            ...
                            <td style="background: #d0e0f4; border-radius: 4px; text-align: center; padding: 8px;">
                                <?php if(!empty($titulo)):
                                    foreach($titulo as $titulo):
                                        $titulo_c = $titulo->programa;
                                        $periodo_c = $titulo->periodo;
                                        $trimestre_c .= $titulo->trimestre.' - ';
                                    endforeach;
                                ?>
                                <div style="font-size: 12px; font-weight: bold; color: #1a3c6e;">
                                    PLANILLA DE INSCRIPCIÓN <?php echo $titulo_c; ?>
                                </div>
                                <div style="font-size: 10px; color: #1a3c6e;">
                                    PERÍODO ACADÉMICO <?php echo $periodo_c; ?> <?php echo $trimestre_c; ?> - SEDE: DISTRITO CAPITAL
                                </div>
                                <?php endif; ?>
                            </td>
                    ...
                    <table class="table-bordered" cellPadding="3" style="margin-top: 2px;">
                        <tr>
                            <th colspan="5" class="section-title">UNIDADES CURRICULARES</th>
                        </tr>
                        <tr>
                            <th class="label-cell" width="12%">CÓDIGO</th>
                            <th class="label-cell" width="45%">UNIDAD CURRICULAR</th>
                            <th class="label-cell" width="13%">UC</th>
                            <th class="label-cell" width="15%">HORAS ACAD.</th>
                            <th class="label-cell" width="15%">INSCRIPCIÓN</th>
                        </tr>
                        <?php if(!empty($materias_pre)):
                            $total_unidades_credito = 0;
                            foreach($materias_pre as $materias_pre):
                        ?>
                        <tr>
                            <td class="data-cell text-center"><?php echo $materias_pre->codigo; ?></td>
                            <td class="data-cell"><?php echo $materias_pre->unidad_curricular; ?></td>
                            <td class="data-cell text-center"><?php echo $materias_pre->uc; ?></td>
                            <td class="data-cell text-center"><?php echo $materias_pre->horas; ?></td>
                            <td class="data-cell text-center"><?php echo ($materias_pre->rev_academica == 1) ? 'SI' : 'NO'; ?></td>
                        </tr>
                        <?php 
                            $total_unidades_credito += $materias_pre->uc;
                            $especializacion = $materias_pre->programa;
                            $trimestre .= $materias_pre->trimestre . ' - ';
                        endforeach; ?>
                        <?php endif; ?>
                    </table>
                    ...
                    <table class="table-bordered" cellPadding="3" style="margin-top: 2px;">
                        ...
                        <tr>
                            ...
                            <td class="data-cell text-center"><?php echo $especializacion; ?></td>
                            <td class="label-cell">TOTAL UC</td>
                            <td class="data-cell text-center"><strong><?php printf('%02d', $total_unidades_credito); ?></strong></td>
                            <td class="label-cell">TRIMESTRE</td>
                            <td class="data-cell text-center"><?php echo $trimestre_c; ?></td>
                        </tr>
                    </table>
                    ...
                    <table class="table-bordered" cellPadding="3" style="margin-top: 2px;">
                        ...
                        <tr class="total-row">
                            ...
                            <th class="text-center" style="padding: 6px; font-size: 11px; color: #1a3c6e;">
                                <?php echo number_format($suma_pago, 2, ',', '.'); ?> Bs.
                            </th>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <div class="note-box">
                                    ...
                                    Los comprobantes bancarios presentados corresponden al pago del costo de las 
                                    <strong>Unidades Crédito</strong> y los <strong>aranceles administrativos</strong> 
                                    (inscripción, permanencia y/o fuera de lapso, según corresponda).
                                    <br>
                                    <span style="font-size: 8px; color: #666;">
                                        <i>Total cancelado: <?php echo number_format($suma_pago, 2, ',', '.'); ?> Bs.</i>
                                    </span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="6" style="height: 100px; vertical-align: bottom; padding: 8px;">
                                <div style="font-size: 9px;">
                                    <strong>Fecha de Pre-Inscripción:</strong> 
                                    <?php echo isset($fecha_preinscripcion) ? date('d/m/Y H:i', strtotime($fecha_preinscripcion)) : '___________'; ?>
                                </div>
                    ...
                    <div style="text-align: center; margin-top: 15px;" class="no-print">
                        <a href="<?php echo base_url();?>planilla/descargar/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4);?>" 
                           target="_blank" 
                           class="btn-download" style="border-radius: 10px; padding: 10px 30px; font-weight: 500; margin-left: 8px; transition: all 0.3s;">
                            <i class="fas fa-download"></i> DESCARGAR PLANILLA PDF
                        </a>
                        <a href="<?php echo base_url(); ?>dashboard04/proceso" class="btn btn-default" style="border-radius: 10px; padding: 10px 30px; font-weight: 500; margin-left: 8px; transition: all 0.3s;">
