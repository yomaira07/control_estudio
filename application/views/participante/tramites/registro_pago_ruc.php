                ...
                <div class="card" style="border: none; border-radius: 10px;">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-0" style="font-weight: 600; color: #2c3e50;">
                                        <strong>Otros Trámites Solicitados</strong>
                                    </h5>
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <table class="table table-hover" style="border-radius: 8px; overflow: hidden; margin-bottom: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            foreach($list_solicitud as $list_solicitud){
                                                $tramite_id = $list_solicitud->id_tramite;
                                            ?>
                                            <tr style="border-bottom: 1px solid #f0f0f0;">
                                                <td style="padding: 10px 15px; font-size: 0.85rem; color: #2c3e50;">
                                                    <?php if ($list_solicitud->id_tramite == 28): ?>
                                                ...
                                                <td style="padding: 10px 15px; font-size: 0.85rem; color: #2c3e50;">
                                                    <?php echo $list_solicitud->programa; ?>
                                                </td>
                                                <?php if($tramite==19 or $tramite==17): ?>
                                                <td style="padding: 10px 15px; text-align: center; font-size: 0.85rem;">
                                                    <span class="badge" style="background: #003366; color: white; padding: 3px 12px; border-radius: 20px;">
                                                        <?php echo $list_solicitud->uc; ?>
                                                    </span>
                                                </td>
                                                <?php endif; ?>
                                                <td style="padding: 10px 15px; text-align: right; font-size: 0.85rem; font-weight: 600; color: #17a2b8;">
                                                    <?php 
                                                        if($datos_trabajo->descuento == 1) 
                                                            $monto = $list_solicitud->monto_mp; 
                                                        else 
                                                            $monto = $list_solicitud->monto_gen; 
                                                        echo number_format($monto, 2, ',', '.') . ' Ref.';
                                                    ?>
                                                </td>
                                                <td style="padding: 10px 15px; text-align: right; font-size: 0.85rem; font-weight: 700; color: #28a745;">
                                                    <?php 
                                                        if($tramite==19 or $tramite==17) {
                                                            $total_pagar = $list_solicitud->uc * $monto;
                                                        } else {
                                                            $total_pagar = $monto;
                                                        }
                                            ...
                                            <tr style="background: #e8f5e9; border-top: 2px solid #28a745; font-weight: 700;">
                                                <td colspan="<?php echo ($tramite==19 or $tramite==17) ? '4' : '3'; ?>" style="padding: 10px 15px; font-size: 0.9rem; color: #1e7e34; text-align: right;">
                        ...
                        <form action="<?php echo base_url(); ?>dashboard09/registro_pago_storage" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="total_ucredito" value="<?php echo $list_solicitud->uc; ?>">
                            ...
                            if($this->session->userdata('fuera_lapso_tra_adm') == 1) { 
                                foreach($aranceles as $aranceles) {
                                    if(($aranceles->id_tramites == 33 || $aranceles->id_tramites == 34) && $mp == 1) 
                                        $total_pagar_fuera_lapso = $aranceles->monto_mp;  
                                    if(($aranceles->id_tramites == 33 || $aranceles->id_tramites == 34) && $mp == 0) 
                                        $total_pagar_fuera_lapso = $aranceles->monto_gen;  
                                }
                            }
                            $total_pagar_gen = $total_pagar + $total_arancel_permanencia_gen + $total_pagar_fuera_lapso;
                            ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12 text-center">
                                 ...
                                 <?php if($list_solicitud->id_tramite==17 ||$list_solicitud->id_tramite==19):?>
                                    <a href="<?php echo base_url(); ?>dashboard09/solicitud_ruc/2" class="btn btn-default" style="border-radius: 0px; padding: 10px 30px; font-weight: 500; margin-left: 8px; transition: all 0.3s;">
                                        <i class="fas fa-arrow-left mr-2"></i>
                                        Cancelar
                                    </a>
                                    <?php
                                 endif;
                                 if($list_solicitud->id_tramite==28):?>
                                    <a href="<?php echo base_url(); ?>dashboard09/solicitud_ruc_requisitos/2" class="btn btn-default" style="border-radius: 0px; padding: 10px 30px; font-weight: 500; margin-left: 8px; transition: all 0.3s;">
                                        <i class="fas fa-arrow-left mr-2"></i>
                                        Cancelar
                                    </a>                               
                                <?php endif;?>
