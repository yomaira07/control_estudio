...
<script language="javascript">
  ...
  function siguiente()
  { 
   if((document.getElementById("rol").value=="5" || document.getElementById("rol").value=="8" ) ){
  //  alert(document.getElementById("periodo").value);
      if( document.getElementById('periodo').value > "15" ){
        location.href="<?php echo base_url()?>dashboard04/datos8";
      }else{
        location.href="<?php echo base_url()?>dashboard04/datos6";
      }
  }
   if(document.getElementById("rol").value=="7") location.href="<?php echo base_url()?>dashboard04/datos9";
  }
  </script>
       <div class="card">
            ...
            <!-- Comienzo formulario -->
<p align="center">
    <strong>En esta secci&oacute;n usted debe de manera obligatoria remitirnos su Fondo negro del Título de pregrado registrado en el SAREN</strong>
  </p>
  ...
  <p align="center">
    ...
    //$rutaarchivo = 'recursos/fotos/' . LocalUser::getCurrentUser()->getIdPersona() . '_foto.jpg';
      $rutaarchivo = base_url().'assets/titulo/' . $this->session->userdata('id') . '_titulo.jpg';
    //echo $rutaarchivo ;
  ...
  <form id="formulario" method="post" enctype="multipart/form-data" action="cargatitulo">
	...
	<input type="hidden" name="trimestre" id="trimestre" value="<?Php echo $this->session->userdata('trimestre'); ?>">
