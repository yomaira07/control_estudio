...
<script language="javascript">
  ...
  function siguiente()
  {
     ...
     location.href="<?php echo base_url()?>dashboard04/datos7";
       ...
       <div class="card">
            ...
            <!-- Comienzo formulario -->
<p align="center">
    <strong>En esta secci&oacute;n usted debe de manera obligatoria remitirnos su cédula de identidad</strong>
  </p>
  ...
  <p align="center">
    ...
    $rutaarchivo = base_url().'assets/cedulas/' . $this->session->userdata('id') . '_cedula.jpg';
    //echo $rutaarchivo ;
