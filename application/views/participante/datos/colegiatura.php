...
<script language="javascript">
  ...
  { 
   ...
   if(document.getElementById("rol").value=="7") location.href="datos11";
       ...
       <div class="card">
            ...
            <!-- Comienzo formulario -->
<p align="center">
    <strong>En esta secci&oacute;n usted debe remitirnos de manera obligatoria su Colegiatura o Constancia de Inscripción del gremio al que pertenezca,dando fe que cumple con los requisitos de ingreso según su especialidad</strong>
  </p>
