                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted" style="font-size: 0.75rem;">
                                        ...
                                        Período: <?php echo isset($periodo->nombre) ? $periodo->nombre : 'N/A'; ?>
                                    </small>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                                    ...
                                    <div class="card-body p-3">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <p style="font-weight: 600; color: #2c3e50; margin-bottom: 0;">
                                                    <i class="fas fa-calendar-alt" style="color: #003366; margin-right: 6px;"></i>
                                                    <?php echo isset($periodo->nombre) ? $periodo->nombre : 'N/A'; ?>
                                                </p>
                                            </div>
                                            <div class="col-md-2">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12 text-center">
                                <a href="<?php echo base_url(); ?>dashboard04/proceso" class="btn btn-primary" style="border-radius: 10px; padding: 10px 40px; font-weight: 500; transition: all 0.3s;">
                                    <i class="fas fa-arrow-left mr-2"></i>
                                    Estatus del proceso de inscripción
                                </a>
