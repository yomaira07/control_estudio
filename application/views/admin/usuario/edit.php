    ...
    <section class="content">
       <div class="card">
                    ...
                    <div class="card-header">
                      <h3 class="card-title"><strong>Edit Usuario</strong></h3>
                    </div>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- Comienzo formulario -->
            <form action="<?php echo base_url()?>admin/usuario/usuario_edit__store" method="POST" name=carga >
                ...
                <input type="hidden" name="fecha_registro" value="<?php echo date('d-m-Y H:i:s'); ?>">
                  ...
                  <div class="form-group">
                    ...
                    <label for="usuario">Usuario</label>
                      ...
                      <div class="col-5">
                        <input type="text" class="form-control" id="usuario" placeholder=""  name="usuario"  onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php echo $list_usuario->username; ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <label for="clave">Trimestre</label>
                      ...
                      <div class="col-5">
                        <input type="text" class="form-control" id="trimestre" placeholder="Ej. I TRIMESTRE,II TRIMESTRE,V TRIMESTRE, SEPARAR CON COMAS LOS TRIMESTRES A CURSAR POR EL ESTUDIANTE" value="<?php echo $list_usuario->trimestre; ?>" name="trimestre" onkeyup="javascript:this.value=this.value.toUpperCase();" >
                      </div>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <option value='1' <?php if ( $list_usuario->modalidad=='1') echo 'selected';?>>PRESENCIAL</option>  
                      <option value='2'  <?php if ( $list_usuario->modalidad=='2') echo 'selected';?>>A DISTANCIA</option>  
                      <option value='1,2'  <?php if ( $list_usuario->modalidad=='1,2') echo 'selected';?>>AMBAS</option>                                  
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <option value="null">Seleccione...</option>
                        <?Php foreach ($list_preinscripcion as $list_preinscripcion){
                          if($list_usuario->id_tiempo_preinscripcion==$list_preinscripcion->id){
                            echo "<option value='".$list_preinscripcion->id."' selected > Desde: ".$list_preinscripcion->fecha_inicio." Hasta: ".$list_preinscripcion->fecha_fin."</option>";    
                          }else{
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                      ...
                      <option value="NULL">Seleccione...</option>
                      <option value='1' <?php if ( $list_usuario->ver_planilla=='1') echo 'selected';?>>SI</option>  
                      <option value='0' <?php if ( $list_usuario->ver_planilla=='0') echo 'selected';?>>NO</option>  
