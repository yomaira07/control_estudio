...
<p align="center">
 ...
 $rutaarchivo = base_url().'assets/transferencia/tramites/'. $id_usuario.'_'.$id_solicitud.'_transf_tramite.jpg';
    //echo $rutaarchivo ;
  ...
  <br/>
<div> <?php
	 $rutaarchivopdf = base_url().'assets/transferencia/tramites/'. $id_usuario.'_'.$id_solicitud.'_transf_tramite.pdf';
