                  ...
                  <div class="card-body">
                      <div class="card">
                          ...
                          <div class="card-header">
                            <h3 class="card-title">Registro de Pago Adicional de Trámites y/o Solicitudes</h3>
                          </div>
                          <div class="card-header">
                      ...
                      <?php endif; ?>
                        <!-- Fin Mensaje de Alerta-->
                         <form action="<?php echo base_url()?>dashboard09/store_pago_adicional" method="POST" enctype="multipart/form-data" >
                            <div class="row">
                            <div class="col-md-9">
                            <!-- Formulario de registro-->
                            <table class="table table-bordered"> 
                                <input type="hidden" name="id_solicitud" value="<?php echo $solicitud; ?>">
                                ...
                                <input type="hidden" name="postgrado" value="<?php echo 'SOLICITUD DE TRAMITE PAGO ADICIONAL'; ?>">
                                <input type="hidden" name="total_ucredito" value="00>">
