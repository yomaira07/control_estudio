              ...
              <div class="card card-primary card-outline">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td><?php echo $listado->periodo;?></td>
                    ...
                    <td><?php echo $listado->id_banco; ?></td>
	            <td><a href="<?php echo base_url()?>dashboard05/transferencia/<?php echo $listado->id_usuario;?>" class="btn btn-warning"><?php echo $listado->nro_referencia; ?></a></td>
                   ...
                   <td><a href="<?php echo base_url()?>dashboard05/postgrado_conc_error/<?php echo $listado->id_usuario;?>/<?php echo $listado->aspirante;?>" class="btn btn-info"> Ver Postgrado(s)</a></td>
