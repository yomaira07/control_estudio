  ...
  function anterior()
  { 
if(document.getElementById('url').value=="consultas")    {
		location.href="/control_estudio/consultas/buscar_periodo_conciliaciones_regulares";
}
if(document.getElementById('url').value=="index")    {
		location.href="/control_estudio/dashboard05/index";
}
  }
                  ...
                  <div class="card-body">
                      <div class="card">
                          ...
                          <div class="card-header">
                            <h3 class="card-title">Postgrado(s) Inscritos por el Estudiante</h3>
 <input type="hidden" name="url" id="url" value="<?Php echo $url; ?>">
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <th>Postgrado</th>
                    <th>Trimestre</th>
                    <th>Total de Unidades Creditos Canceladas------------------------------------------------------------>  <?php echo str_pad($suma_unidad, 2,0,STR_PAD_LEFT); ?> </th>                  
                  </tr>
