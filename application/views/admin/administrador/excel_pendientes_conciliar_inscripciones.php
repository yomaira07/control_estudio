...
<body>
    ...
    <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">
        ...
        <tr>
            <td colspan="19" align="center"><h2>LISTADO DE PAGOS PENDIENTES POR CONCILIAR</h2></td>
        </tr>
        <tr>
            <td colspan="19">&nbsp;</td>
        </tr>
    ...
    <table border="1" cellpadding="5" cellspacing="0" align="center" width="100%">
	    ...
	    <th style="color:#1060C8; font-weight:bold; text-align:center;">Teléfono</th>
            ...
            <th style="color:#1060C8; font-weight:bold; text-align:center;">U.C. por Trimestre</th>
  ...
  <td><?php echo isset($row->tel_cel) ? $row->tel_cel : ''; ?></td>
            ...
            <td><?php echo isset($row->uc_por_trimestre) ? $row->uc_por_trimestre : ''; ?></td>
            <td align="center"><?php echo isset($row->total_uc) ? $row->total_uc : 0; ?></td>
        ...
        <tr bgcolor="#999999">
            ...
            <td style="color:#FFFFFF; font-weight:bold; text-align:right;"><?php echo $total_monto_pagar; ?></td>
            <td style="color:#FFFFFF; font-weight:bold; text-align:right;"><?php echo $total_monto_depositado; ?></td>
