              ...
              <div class="card card-primary card-outline">
                      ...
                      <div class="card">
                          ...
                          <div class="card-header">
                            <h3 class="card-title">Pagos Conciliados</h3>
                             ...
                             <div class="card-header">
                         <a title="Descargar a Excel Pagos Conciliados" href="<?php  echo base_url()?>dashboard05/exportar_excel_conciliados" target="_blank">Descargar Excel pagos conciliados<img src="<?php echo base_url(); ?>assets/img/excel.jpg"  alt="Excel" style="width: 10mm; height: 10mm; margin: 0;" /></a>
                 ...
                 <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td><?php echo $listado->periodo; ?></td>
                    ...
                    <td><?php if($listado->pago_adicional==0):?><a href="<?php echo base_url()?>dashboard05/postgrado_conc/<?php echo $listado->id_usuario;?>/<?php echo $listado->aspirante;?>" class="btn btn-info"> Ver Postgrado(s)</a><?php endif;?></td>
