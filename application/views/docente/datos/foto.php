...
<script language="javascript">
  ...
  function siguiente()
  { 
    location.href="<?php echo base_url()?>dashboard06/datos4";
  }
  </script>
       <div class="card">
          
                    <div class="card-header">
                      <h3 class="card-title"><strong>Adjuntar Foto Tipo Carnet</strong></h3>
                    </div>
            ...
            <!-- Comienzo formulario -->
<p align="center">
    <strong>En esta secci&oacute;n usted puede remitirnos su foto personal</strong>
  </p>
  <div class="frame3" align="center">
  <p align="center">
    Para poder enviarnos su foto, el archivo debe estar en cualquiera 
  ...
  <p align="center">
   <div> 
    ...
    <img id='imgFoto' border='2' class='fotomarket' width='150px' height='165px' src='<?php echo $imagen;?> '  />
    <?php }else{ 
      
      ?>
     <img id='imgFoto' border='2' class='fotomarket' width='150px' height='165px' src='<?php echo $imagen;?>' title="La Imagen no ha sido cargada" />
     <?php } ?>
   </div>
  </p>
  <br/>
  ...
  <input type="hidden" name="id_docente" value="<?php if ($datos_docente==false){echo "falso";}else{ echo $datos_docente->id;  } ?>">
    ...
    <input type="hidden" name="tipo_requisito" id="tipo_requisito" value="fotos_docente">
    <input type="file" name="userfile" size="400" required="true" /> 
    <br/><br/>
    <input type="submit" name="upload"  value="Cargar foto" class="boton"/>
  </form>
