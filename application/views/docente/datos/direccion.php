    ...
    <section class="content">
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <h3 class="card-title"><strong>Dirección de Domicilio del Docente</strong></h3>
                    </div>
                      ...
                      <?php endif; ?>
                        ...
                        <!-- Comienzo formulario -->
            <form action="<?php echo base_url()?>dashboard06/direccion_store/<?Php echo $this->session->userdata('id'); ?>" method="POST" name=carga >
            ...
            <input type="hidden" name="no_encontrado" value="<?php if ($datos_direccion==false){echo "falso";}else{ echo $datos_direccion->id;  } 
                ...
                <input type="hidden" name="fecha_registro" value="<?php echo date('d-m-Y H:i:s'); ?>">
                  ...
                  <div class="form-group ">
                    ...
                    <label for="domicilio" title="-Dato Obligatorio-">(*) Domicilio</label>
                    <input type="text" class="form-control" id="domicilio" placeholder="Indicar el domicilio completo" name="domicilio" onkeyup="javascript:this.value=this.value.toUpperCase();" value="<?php if ($datos_direccion==false){echo "";}else{ echo $datos_direccion->domicilio;  } 
                        ?>" required>
                  </div>
