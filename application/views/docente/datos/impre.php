   ...
   //location.href="datos10/";
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <h3 class="card-title"><strong>Adjuntar IMPRES-Médico o de INPRE-Abogado</strong></h3>
                    </div>
            ...
            <!-- Comienzo formulario -->
<p align="center">
    <strong>En esta secci&oacute;n usted puede remitirnos su IMPRES Médico o INPRE de Abogado dando fe que cumple con los requisitos de ingreso según su especialidad.</strong>
  </p>
 ...
 <input type="hidden" name="rol" id="rol" value="<?Php echo $this->session->userdata('rol'); ?>">
    ...
    <br/><br/>
    <input type="submit" name="upload"  value="Cargar IMPRES/INPRE" class="boton"/>
  </form>
