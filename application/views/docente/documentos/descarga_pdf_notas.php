...
<style>@page {
    ...
    <table border="0" cellpadding="5" cellspacing="1" align="center">
          ...
          foreach($unidad_curricular as $unidad_curricular){
                    ...
                    if($unidad_curricular->sigla_uc=='SEI' or $unidad_curricular->sigla_uc=='SEIII' or $unidad_curricular->sigla_uc=='SEII'){                        
                        $nota=array('20','40');
...
<!--            <th bgcolor="#D0E0F4" color="#1060C8">MODALIDAD</th>         
          ...
          <tr >
            ...
            <th colspan="8" bgcolor="#D0E0F4" color="#1060C8">VALOR TOTAL DE CADA EVALUACIÓN</th>
