...
<style>@page {
    ...
    <table border="0" cellpadding="5" cellspacing="1" align="center">
          ...
          <tr>
            <td colspan="2">&nbsp;</td>       
            <th colspan="4" bgcolor="#D0E0F4" color="#1060C8">EVALUACIÓN CONTÍNUA</th>                    
            <td colspan="6">&nbsp;</td>
          </tr>
          <tr >
            <td colspan="10">&nbsp;</td>            
          ...
          <tr >
            <td colspan="10">&nbsp;</td>            
            <th bgcolor="#D0E0F4" color="#1060C8">FORMA N°</th>
            <td colspan="3" bgcolor="#999999" color="#FFFFFF"></td>      
          </tr>
           <tr >
            <td colspan="14">&nbsp;</td>          
          </tr>
...
<!--            <th bgcolor="#D0E0F4" color="#1060C8">MODALIDAD</th>         
             <td colspan="4" bgcolor="#999999" color="#FFFFFF"><?php if($oferta->modalidad==1)echo "PRESENCIAL";if($oferta->modalidad==2)echo "VIRTUAL";if($oferta->modalidad==3)echo "SEMIPRESENCIAL";?></td>      -->
            <td colspan="6"></td>   
          </tr>
          <tr >
            <td colspan="14">&nbsp;</td>
          ...
          <tr >
            ...
            <th colspan="18" bgcolor="#D0E0F4" color="#1060C8">VALOR TOTAL DE CADA EVALUACIÓN</th>
          ...
          <tr >
            ...
            <th   colspan="2" bgcolor="#D0E0F4" color="#1060C8">4ª</th>
             <th  colspan="2" bgcolor="#D0E0F4" color="#1060C8">5ª</th>
            <th   colspan="2" bgcolor="#D0E0F4" color="#1060C8">6ª</th>
            <th   colspan="2" bgcolor="#D0E0F4" color="#1060C8">7ª</th>
            <th  colspan="2" bgcolor="#D0E0F4" color="#1060C8">8ª</th>
            <th colspan="2" bgcolor="#D0E0F4" color="#1060C8">9ª</th>
          ...
          <tr >
           ...
           <th  bgcolor="#D0E0F4" color="#1060C8">NOMBRES</th>
            ...
            <th   colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota4_e?>%</th>
           <th    colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota5_e?>%</th>
            <th   colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota6_e?>%</th>
            <th   colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota7_e?>%</th>
            <th   colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota8_e?>%</th>
            <th   colspan="2" bgcolor="#999999" color="#FFFFFF"><?php echo $nota9_e?>%</th>
          </tr>
          ...
          <tr >
            ...
            <td  align="right"><?php echo $notas->nota_5;?></td>
            <td  align="right" ><?php  $total5=(($notas->nota_5 * $nota5_e)/100); echo number_format($total5,2); ?></td>
            <td  align="right"><?php echo $notas->nota_6;?></td>
            <td  align="right"><?php $total6=(($notas->nota_6 * $nota6_e)/100); echo number_format($total6,2); ?></td>
            <td  align="right"><?php echo $notas->nota_7;?></td>
            <td  align="right"><?php  $total7=(($notas->nota_7 * $nota7_e)/100); echo number_format($total7,2);?></td>
            <td  align="right" ><?php echo $notas->nota_8;?></td>
            <td  align="right" ><?php  $total8=(($notas->nota_8 * $nota8_e)/100); echo number_format($total8,2);?></td>  
            <td  align="right" ><?php echo $notas->nota_9;?></td>  
            <td  align="right" ><?php  $total9=(($notas->nota_9 * $nota9_e)/100); echo number_format($total9,2);?></td>        
        ...
        <tbody>
          ...
          <tr >
           ...
           <tr >
            ...
            <td colspan="9"><?php echo $eva->nota4.'% '.$eva->tipo_evaluacion4; ?></td>
            <td align="center"><?php echo  $dia=date("d", strtotime($eva->fecha_evaluacion4)); ?></td>
            <td align="center"><?php echo $mes=date("m",strtotime($eva->fecha_evaluacion4)); ?></td>
            <td align="center" ><?php echo  $anno=date("Y", strtotime($eva->fecha_evaluacion3)); ?></td>
            
          </tr>
                    <tr >
            <th bgcolor="#999999" color="#FFFFFF" >5ª</th>
            <td colspan="9"><?php echo $eva->nota5.'% '.$eva->tipo_evaluacion5 ?></td>
            <td align="center"><?php echo  $dia=date("d", strtotime($eva->fecha_evaluacion5)); ?></td>
            <td align="center"><?php echo $mes=date("m", strtotime($eva->fecha_evaluacion5)); ?></td>
            <td align="center"><?php echo  $anno=date("Y", strtotime($eva->fecha_evaluacion5)); ?></td>
           
          </tr>
          <tr >
            <th bgcolor="#999999" color="#FFFFFF">6ª</th>
             <td colspan="9"><?php echo $eva->nota6.'% '.$eva->tipo_evaluacion6 ?></td>
            <td align="center"><?php echo  $dia=date("d", strtotime($eva->fecha_evaluacion6)); ?></td>
            <td align="center"><?php echo $mes=date("m",strtotime($eva->fecha_evaluacion6)); ?></td>
            <td align="center" ><?php echo  $anno=date("Y", strtotime($eva->fecha_evaluacion6)); ?></td>
