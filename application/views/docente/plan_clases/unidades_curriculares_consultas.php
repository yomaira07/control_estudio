    ...
    <section class="content">
       ...
       <div class="card">
                    ...
                    <div class="card-header">
                      <h3 class="card-title"><strong>Unidades Curriculares Impartidas por el docente
                      </strong></h3>
            ...
            <div class="panel-body">
                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-condensed" id="example" width="100%">
                    ...
                    <?Php $i=0;
                        ...
                        <td>
                            <a href="<?php echo base_url(); ?>dashboard06/constancias_docente/<?= $id_usuario;?>/<?= $uc->id; ?>/<?=$uc->id_periodo; ?>"  name="item" class="">
