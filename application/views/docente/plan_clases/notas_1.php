...
//alert  (id); 
                ...
                valor2=document.forms.form.elements.nota2.value;
                valor3=document.forms.form.elements.nota3.value;
                //    alert(unidad);  
                // alert(valor);    alert(retiro);
              //   alert(valor2);  alert(valor3); 
                if(unidad=='SEM' ){  
                    valor4=document.forms.form.elements.nota4.value;
                    total =  Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value)+Number.parseFloat(document.forms.form.elements.nota4_f.value);
                }
                if(unidad=='SEM1' ){  
                        total =  Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value);
               ...
               //  alert(total); 
                ...
                document.forms.form.elements.nota1_f.value = total_ptos;
                document.forms.form.elements.final.value = Math.round(total_final);
                // alert(unidad);
                if ( unidad=='SEM' && retiro ==0){
                    if((valor <15 || valor2< 15 || valor3 <15 || valor4<15 )  ){
                     //     alert(unidad);
                        document.forms.form.elements.observaciones.value='REPROBADO';
                        document.forms.form.elements.observaciones.style.color="Red";
                        document.forms.form.elements.final.value =14;                    
                    }
                }
                ...
                if(unidad=='SEM1' && retiro ==0){
                    if((valor< 15 || valor2< 15 || valor3 <15  )  ){
                      //    alert(unidad);  alert(total_final);
                        ...
                        document.forms.form.elements.observaciones.value=' ';                   
                    }
                }   
            }
            function punto2(valor,id){       
                ...
                var retiro=document.forms.form.elements.retiro.value ;
                valor = parseInt(valor); // Convertir el valor a un entero (número).
                valor1=document.forms.form.elements.nota1.value;
                valor3=document.forms.form.elements.nota3.value;

                if(unidad=='SEM' ){  
                    valor4=document.forms.form.elements.nota4.value;
                    total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value)+Number.parseFloat(document.forms.form.elements.nota4_f.value);
                }
                if(unidad=='SEM1' ){  
                        total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value);
                    }else{
                        total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value)+Number.parseFloat(document.forms.form.elements.nota4_f.value);
                }
                ...
                total_final = Number.parseFloat(total) + Number.parseFloat(total_ptos);
                // Colocar el resultado de la suma en el control "span".
                document.forms.form.elements.nota2_f.value = total_ptos;
                document.forms.form.elements.final.value =Math.round(total_final);
                if ( unidad=='SEM' && retiro ==0){
               ...
               // alert(valor); alert(valor2); alert(valor3);
                ...
                if(unidad=='SEM' ){  
                    valor4=document.forms.form.elements.nota4.value;
                    total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota4_f.value);
                }
                if(unidad=='SEM1' ){  
                        total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota2_f.value);
                    }else{
                        total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota4_f.value);
                }
                ...
                total_final = Number.parseFloat(total) + Number.parseFloat(total_ptos);
                // Colocar el resultado de la suma en el control "span".
                document.forms.form.elements.nota3_f.value = total_ptos;
                document.forms.form.elements.final.value =Math.round(total_final);
               ...
               // alert(valor); alert(valor2); alert(valor3);
                ...
                if(unidad=='SEM' ){  
                    ...
                    total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value);
                }
                if(unidad=='SEM1' ){  
                        total =  Number.parseFloat(document.forms.form.elements.nota1_f.value)+Number.parseFloat(document.forms.form.elements.nota2_f.value)+Number.parseFloat(document.forms.form.elements.nota3_f.value);
                    }else{
               ...
               {valor1 = (valor1 == null || valor1 == undefined || valor1 == "") ? 0 : parseInt(valor1);}
                ...
                total_final = Number.parseFloat(total) + Number.parseFloat(total_ptos);
                // Colocar el resultado de la suma en el control "span".
                document.forms.form.elements.nota4_f.value = total_ptos;
                document.forms.form.elements.final.value =Math.round(total_final);               
               // alert(valor); alert(valor2); alert(valor3);
                if(unidad=='SEM1' && retiro ==0){
            ...
            <div class="card">
                ...
                <div align="right">
                 ...
                 <a href="<?php echo base_url(); ?>dashboard06/asistencia/<?= $oferta_academica; ?>"  name="item" class="">
                    ...
                    <h3 class="card-title"><strong>Unidad Curricular :  </strong>
                        <?php foreach($unidad_curricular as $unidad_curricular){
                                ...
                                if($unidad_curricular->sigla_uc=='SEI' or $unidad_curricular->sigla_uc=='SEII' or $unidad_curricular->sigla_uc=='SEIII'or  $unidad_curricular->sigla_uc=='SI1'or $unidad_curricular->sigla_uc=='SI'){  
                                    if($unidad_curricular->programa=='10' ){    // solo CPP Victimologiaa
                                        $unidad='SEM';
                    ...
                    <div align="center">
                        <?php if($revision==1 and ($this->session->userdata("rol")==2 || $this->session->userdata("rol")==10)  ){?>
                            <input type="button" name="btnSeguiente" value="Regresar" class="boton btn btn-info"  title="Regresar" onClick="anterior2()">                           
                           
                       <?php }
                       if($revision==0 and ($this->session->userdata("rol")==2 || $this->session->userdata("rol")==10 )){?>
                            <input type="button" name="btnSeguiente" value="Regresar" class="boton btn btn-info"  title="Regresar" onClick="anterior1()">   
                           
                       <?php }
                        if($revision =='2' and ($this->session->userdata("rol")==2 || $this->session->userdata("rol")==10) ){?>
                       ...
                       if( $this->session->userdata("rol")==9){ ?>
                        ...
                        <div align="right">
                            ...
                            <?php if( (($rol_usuario->rol_id==2 ) and ($proceso_cerrado==0)) ){ ?>
                                ...
                                <?php $cerrado=0;
                                }elseif( $rol_usuario->rol_id==2  and ($proceso_cerrado>0)){?>
     ...
     <tbody>      
                                    <?php  foreach ($notas as $notas)   {   $n++;?>                                   
                                        ...
                                        ?>
                                            <?php if (($notas->retiro=='1'  or $notas->retiro=='2'or $notas->retiro=='3') and ($this->session->userdata("rol")==9 or $this->session->userdata("rol")==10 or $this->session->userdata("rol")==2) ){ $bloqueo='readonly'; $disabled='disabled';}else{ $bloqueo=' '; $disabled='';}?>
                                        <tr>     
                                            <td >
                                                <div>
                                            ...
                                            <?php if (($notas->retiro=='1'  or $notas->retiro=='2') and ($this->session->userdata("rol")==9 or $this->session->userdata("rol")==10 or $this->session->userdata("rol")==2) ){ $bloqueo='readonly'; }else{ $bloqueo=' '; }?>
                                         ...
                                         <!--   <td>
                                            ...
                                            <?php } ?>
                                            <?php if( ($this->session->userdata("rol")==10 OR $this->session->userdata("rol")==2) and $revision<>'1' ){ ?>
                                             <!--   <td>
                                                    <div>
...
if( (($rol_usuario->rol_id==2 ) and ($proceso_cerrado==0)) ){ ?>
                                <input type="button" name="btnCerrar" value="Cerrar Registro de Notas" class="boton btn btn-success"  title="Cerrar Registro de Notas" onClick="cerrar_proceso(<?php echo $oferta_academica;?>);">
                                <a title="Descargar Plan de Clases y Evaluaciones" href="<?php  echo base_url()?>dashboard06/dPDF/<?php echo $oferta_academica;?>"" target="_blank"><img src="<?php echo base_url(); ?>assets/img/pdf.jpeg"  alt="PDF" style="width: 10mm; height: 10mm; margin: 0;" /></a>
                                <?php  $cerrado=0;
                                }elseif( $rol_usuario->rol_id==2  and ($proceso_cerrado>0)){?>
