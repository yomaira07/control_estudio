        ...
        <div class="card">
            <div class="card-header">
                ...
                echo $unidad_curricular->codigo.' '.$unidad_curricular->nombre;
                        ...
                        $plan1='BORRADOR DE PROYECTO';
                        $plan2='REVISIÓN DEL PROYECTO POR PARTE DEL ASESOR METODOLÓGICO';
                        $plan3='REVISIÓN DEL PROYECTO POR PARTE DEL EXPERTO EVALUADOR';
                        $plan4='REVISIÓN DEL PROYECTO POR PARTE DEL TUTOR';
            ...
            <div class="panel panel-default">
                ...
                <?php $i=1;   ?>
                 ...
                 <?php  if (!empty($eva)){
                  //  echo "actualiza";
                   // foreach ($eva as $eva ) { ?>    
                          <input type="text" name="id" id ="id" value="<?php print $eva->id_evaluacion; ?>" >
                            <tbody>
                                <tr>
                                <td><?php echo $i++;?></td>
