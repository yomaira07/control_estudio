  ...
  <div class="content-wrapper">
    ...
    <script language="javascript">
     ...
     function punto1(valor,id){       
            ...
            valor5=document.forms[id].elements.nota5.value;

            total = Number.parseFloat(document.forms[id].elements.nota2_f.value)+Number.parseFloat(document.forms[id].elements.nota3_f.value)+Number.parseFloat(document.forms[id].elements.nota4_f.value)+Number.parseFloat(document.forms[id].elements.nota5_f.value);
           ...
           valor5 = (valor5 == null || valor5 == undefined || valor5 == "") ? 0 : parseInt(valor5);
            /* Esta es la suma. */
            ...
            // alert(unidad);
            if((valor3< 15 || valor4 <15 || valor5<15)&& unidad=='SEIII' && retiro==0){
    ...
    function punto2(valor,id){       
        ...
        var retiro=document.forms[id].retiro.value;
            ...
            valor = parseInt(valor); // Convertir el valor a un entero (número). nota2
            valor1=document.forms[id].elements.nota1.value;
            valor3=document.forms[id].elements.nota3.value;
            valor4=document.forms[id].elements.nota4.value;
            valor5=document.forms[id].elements.nota5.value;
            unidad=  document.forms[id].elements.unidad.value;

            total = Number.parseFloat(document.forms[id].elements.nota1_f.value)+Number.parseFloat(document.forms[id].elements.nota3_f.value)+Number.parseFloat(document.forms[id].elements.nota4_f.value)+Number.parseFloat(document.forms[id].elements.nota5_f.value);
            ...
            // Aquí valido si hay un valor previo, si no hay datos, le pongo un cero "0".
            total = (total == null || total == undefined || total == "") ? 0 : total;
            valor1 = (valor== null || valor1 == undefined || valor1 == "") ? 0 : parseInt(valor1);
            valor2 = valor;
              valor3 = (valor3 == null || valor3 == undefined || valor3 == "") ? 0 : parseInt(valor3);
           valor4 = (valor4 == null || valor4 == undefined || valor4 == "") ? 0 : parseInt(valor4);
           valor5 = (valor5 == null || valor5 == undefined || valor5 == "") ? 0 : parseInt(valor5);
    ...
    function punto3(valor,id){       
            ...
            valor5=document.forms[id].elements.nota5.value;
             unidad=  document.forms[id].elements.unidad.value;
             total = Number.parseFloat(document.forms[id].elements.nota1_f.value)+Number.parseFloat(document.forms[id].elements.nota2_f.value)+Number.parseFloat(document.forms[id].elements.nota4_f.value)+Number.parseFloat(document.forms[id].elements.nota5_f.value);
    ...
    function punto4(valor,id){       
            ...
            valor5=document.forms[id].elements.nota5.value;
             unidad=  document.forms[id].elements.unidad.value;
             total = Number.parseFloat(document.forms[id].elements.nota1_f.value)+Number.parseFloat(document.forms[id].elements.nota2_f.value)+Number.parseFloat(document.forms[id].elements.nota3_f.value)+Number.parseFloat(document.forms[id].elements.nota5_f.value);
    ...
    function punto5(valor,id){       
            ...
            unidad=  document.forms[id].elements.unidad.value;
            total = Number.parseFloat(document.forms[id].elements.nota1_f.value)+Number.parseFloat(document.forms[id].elements.nota2_f.value)+Number.parseFloat(document.forms[id].elements.nota3_f.value)+Number.parseFloat(document.forms[id].elements.nota4_f.value);

            porcentaje=document.forms[id].elements.nota5_e.value /100;
            //alert(valor);
            //  alert(total); 
            //  alert(porcentaje); 
            // Aquí valido si hay un valor previo, si no hay datos, le pongo un cero "0".
       ...
       <div class="card">
                    ...
                    if($unidad_curricular->sigla_uc=='SEIII'){                        
                        $unidad='SEIII';
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered table-condensed" id="example1" width="100%">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="background: #50aec49e;"> Nota N° 3 <br>(<?php echo $nota3_e; ?> %)</th>
                            <th style="background: #50aec49e;"> Nota N° 4 <br>(<?php echo $nota4_e; ?> %)</th>
                            <th style="background: #50aec49e;"> Nota N° 5 <br>(<?php echo $nota5_e; ?> %)</th>
                 ...
                 <tbody>
                   <?php if( $rol_usuario->rol_id==2 and $revision=='1' ){ $readonly='readonly';}else{$readonly='';}?>
                    <tr>
                        ...
                        <?php if (($notas->retiro=='1'  or $notas->retiro=='3') and ($this->session->userdata("rol")==9 or $this->session->userdata("rol")==10 or $this->session->userdata("rol")==2) ){ $bloqueo='readonly'; }else{ $bloqueo=' '; }?>
                        ...
                        <td><input type="number" max="20" min="0"onkeypress="return controltag(event)"  name="nota5" 
				onblur="javasript:punto5(this.value,<?php echo $i?>);"  value="<?php echo $nota5=$notas->nota_5;?>" 
				<?php print $readonly; print $bloqueo;?>> <div>
				<input type="text"  id ="nota5_f"  name="nota5_f" size="4" readonly value="<?php   $total5=(($nota5 * $nota5_e)/100); echo $total5?> " >ptos.</div></td>
