                ...
                foreach($unidad_curricular as $unidad_curricular){
                    echo $unidad_curricular->codigo.' '.$unidad_curricular->nombre.$unidad_curricular->des_programa;
                       $nota1_e=5;$nota2_e=10;$nota3_e=10;$nota4_e=10;$nota5_e=10;$nota6_e=5;
                        $plan1='PRESENTACIÓN DEL TEMA DE INVESTIGACIÓN Y PARADIGMA DE ABORDAJE';
                        $plan2='AVANCE ESCRITO DEL CAPITULO O FASE 1';
                        $plan3='AVANCE ESCRITO DEL CAPITULO O FASE 2';
                        $plan4='AVANCE ESCRITO DEL CAPITULO O FASE 3'; 
                        $plan5='PRESENTACIÓN DEL PROYECTO';
                        $plan6='ASISTENCIA ACTIVA';
                        $plan7='REVISIÓN DEL PROYECTO POR PARTE DEL ASESOR METODOLÓGICO';
                        $plan8='REVISIÓN DEL PROYECTO POR PARTE DEL EXPERTO EVALUADOR';
                        $plan9='REVISIÓN DEL PROYECTO POR PARTE DEL TUTOR';
                        $readonly_plan1='readonly';
                        $readonly_plan2='readonly';
                        $readonly_plan3='readonly';
                        $readonly_plan4='readonly';
                        $readonly_plan5='readonly';
                        $readonly_plan6='readonly';
                        $readonly_plan7='readonly';
                        $readonly_plan8='readonly';
                        $readonly_plan9='readonly';
                        $programa=2;// maestria*/
                    ...
                    foreach ($eva as $eva ) { ?>    
                          <input type="hidden" name="id" id ="id" value="<?php print $eva->id_evaluacion; ?>" >
                            <tbody>
                                ...
                                <tr>
                                <td><?php echo $i++;?></td>
                                <td><input type="text" name="nota6" id ="nota6" value="<?php print $nota6_e; ?>" readonly size="5"></td>
                                <td><input type="text" name="tipo_evaluacion6" id ="tipo_evaluacion6" value="<?php print $eva->tipo_evaluacion6; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();" <?php echo $readonly_plan6;?> size="80" placeholder="Ejemplo. Prueba Oral,Trabajo Escrito,etc." required></td>
                                <td><input type="date" name="fecha_evaluacion6" id ="fecha_evaluacion6" value="<?php print $eva->fecha_evaluacion6; ?>" required></td>
                                </tr>                            
                            ...
                            <?php }
                                ...
                                <tr>
                                     <td><?php echo $i++;?></td>
                                <td><input type="text" name="nota6" id ="nota6" value="<?php print $nota6_e; ?>" readonly size="5"></td>
                                <td><input type="text" name="tipo_evaluacion6" id ="tipo_evaluacion6" value="<?php print  $plan6; ?>" onkeyup="javascript:this.value=this.value.toUpperCase();" <?php echo $readonly_plan6;?> size="80" placeholder="Ejemplo. Prueba Oral,Trabajo Escrito,etc." required></td>
                                <td><input type="date" name="fecha_evaluacion6" id ="fecha_evaluacion6" value="<?php print $eva->fecha_evaluacion6; ?>" required></td>
                                </tr>                            
