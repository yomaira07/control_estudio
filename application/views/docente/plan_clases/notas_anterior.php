 ...
 <div class="content-wrapper">
    ...
    <section class="content">
            <script language="javascript">
                function anterior()
                { 
                if( document.forms.form.elements.rol.value=='2'){
                                    ...
                                    <tbody>                  
                                        ...
                                        <tr>     
                                            ...
                                            <?php if (($notas->retiro=='1'  or $notas->retiro=='2') and ($this->session->userdata("rol")==9 or $this->session->userdata("rol")==10 or $this->session->userdata("rol")==2) ){ $bloqueo='readonly'; }else{ $bloqueo=' '; }?>
                                                <td><input type="number"  max="20" min="0" onkeypress="return controltag(event);"   name="nota1[]" id="nota1" onblur="javasript:punto1(this.value,<?php echo $i?>);" value="<?php echo $nota1=$notas->nota_1;?>" <?php print $readonly; print $bloqueo;?>> 
                                                <div><input type="text"  id ="nota1_f" name="nota1_f[]"  size="4"  disabled value="<?php $total1=(($nota1 * $nota1_e)/100); echo $total1;?> " >ptos.</div></td>

                                                <td><input type="number" max="20" min="0"onkeypress="return controltag(event)" name="nota2[]" id="nota2"   onblur="javasript:punto2(this.value,<?php echo $i?>);"  value="<?php echo $nota2=$notas->nota_2;?>" <?php print $readonly; print $bloqueo;?>> 
                                                <div><input type="text" name="nota2_f[]" id ="nota2_f" size="4" disabled value="<?php   $total2=(($nota2 * $nota2_e)/100); echo $total2; ?> " >ptos.</div></td>

                                                <td><input type="number" max="20" min="0"onkeypress="return controltag(event)"  id="nota3" name="nota3[]" onblur="javasript:punto3(this.value,<?php echo $i?>);"  value="<?php echo $nota3=$notas->nota_3;?>" <?php print $readonly; print $bloqueo;?>> 
                                                <div><input type="text"  name="nota3_f[]" id ="nota3_f"  size="4" disabled value="<?php   $total3=(($nota3 * $nota3_e)/100); echo $total3;?> " >ptos.</div></td>

                                                <?php if ($ocultar==0){?>
                                                <td><input type="number" max="20" min="0"onkeypress="return controltag(event)"  name="nota4[]" onblur="javasript:punto4(this.value,<?php echo $i?>);"  value="<?php echo $nota4=$notas->nota_4;?>" <?php print $readonly; print $bloqueo;?>> 
                                                <div><input type="text"  id ="nota4_f"  name="nota4_f[]" size="4" disabled value="<?php   $total4=(($nota4 * $nota4_e)/100); echo $total4?> " >ptos.</div></td>
                                            <?php } ?>
                                            <td><input type="text" max="20" min="0"  id ="final" name="final[]" value="<?php echo $notas->nota_final; ?>"> <div> <?php echo'ptos.';?></div></td>
                                            <td>  
