...
|--------------------------------------------------------------------------
|
| Detección dinámica de URL base. Funciona tanto en localhost como detrás
| de un proxy inverso (Cloudflare Tunnel, ngrok, balanceadores, etc.).
|
| Detecta:
|  - Protocolo (http o https) considerando proxy inverso
|  - Host real (dominio o IP)
|  - Subcarpeta donde está instalada la app
|
*//*
|--------------------------------------------------------------------------
| Base Site URL - Detección dinámica robusta
|--------------------------------------------------------------------------
*//*
|--------------------------------------------------------------------------
...
// Credenciales BDV - Pago electrónico
$config['bdv_afiliado'] = '73002974';     // Reemplazar con usuario real
$config['bdv_clave'] = '4k0DpHbn';    // Reemplazar con password real
